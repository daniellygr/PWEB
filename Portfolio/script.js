...
function hobbies() {
    ...
    paragrafo1.textContent = "Amo Correr!";
    paragrafo2.textContent = "Meu principal hobbie é fotografar!";
    paragrafo3.textContent = "Ah... também faço crochê (e amigurumis!)";

    var imagem = document.getElementById("imagemConteudo");
    imagem.src = "imagem/hobbie.jpg";
    imagem.rel = "Fotografando";

    var imagem1 = document.getElementById("imagemBox");
    imagem1.src = "imagem/hobby.png";
}
